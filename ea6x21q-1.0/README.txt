...
add this to your device Tree File
 ...
 dkms remove -m ea6621q -v 1.0 ; dkms add -m ea6621q -v 1.0 && dkms build -m ea6621q -v 1.0 &&  dkms install -m ea6621q -v 1.0 ||  cat /var/lib/dkms/ea6621q/1.0/build/make.log
